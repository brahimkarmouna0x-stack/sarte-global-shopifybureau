...
const PAGE_TITLE = "Portfolio & Cases | website shopify bureau - Sarte Global";
const PAGE_DESC =
  "Bekijk ons portfolio en succesvolle cases van website shopify bureau Sarte Global. Ontdek onze bureau gemaakte Shopify en WooCommerce webshops.";
