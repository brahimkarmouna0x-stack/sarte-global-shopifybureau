...
const PAGE_TITLE = "Contact | website shopify bureau Experts — Sarte Global";
const PAGE_DESC =
  "Neem contact op met Sarte Global, het team achter shopifybureau.nl. E-mail of WhatsApp — we reageren binnen één werkdag.";
