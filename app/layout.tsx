...
// Primary service name — used in Service JSON-LD and footer/nav copy
const SERVICE_NAME = "Shopify bureau";
...
export const metadata: Metadata = {
  ...
  keywords: [
    // Primary transactional keywords — highest commercial intent for NL market
...
const SERVICE_JSON_LD = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": `${SITE_URL}/#service-shopify-bureau`,
  name: "Shopify bureau Nederland",
  serviceType: "Shopify webshop laten maken",
  provider: { "@id": `${SITE_URL}/#organization` },
  areaServed: areaServedNL(),
  description:
    "Shopify webshop laten maken bij Sarte Global — uw Shopify bureau in Nederland. Professionele Shopify- en WooCommerce-webshops met sterke SEO, snelle oplevering en conversiegericht design.",
};
