...
const PATH = "/over-ons";
const PAGE_TITLE = "Over ons — website shopify bureau | Sarte Global";
const PAGE_DESC =
  "Sarte Global is het bureau achter shopifybureau.nl. We bouwen professionele websites en webshops voor ondernemers en bedrijven in Nederland.";
