...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/woocommerce-bureau`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/shopify-bureau`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/b2b-website`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/b2c-website`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
