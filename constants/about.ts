...
export const ABOUT_COMPANY = {
  ...
  lead:
    "Sarte Global is het bureau achter shopifybureau.nl. We bouwen professionele, moderne en responsive websites en webshops voor ondernemers en bedrijven in Nederland, met een focus op sterke SEO, snelle laadtijden en maximaal resultaat als toonaangevend website shopify bureau.",
  paragraphs: [
