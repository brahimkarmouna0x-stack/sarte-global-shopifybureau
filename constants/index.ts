...
export const SITE = {
  // Title: 56 chars — primary keyword "Shopify bureau" + brand, proper Dutch
  title: "Shopify Bureau Nederland | Webshop Laten Maken – Sarte Global",
  // Description: 150 chars — natural Dutch, primary keyword in first clause, clear CTA
  description:
    "Shopify webshop laten maken bij Sarte Global — uw Shopify bureau in Nederland. Professioneel, snel live en conversieklaar. Vraag vandaag nog een gratis offerte aan.",
  themeColor: "#0D0D0D",
  brandName: "SARTE GLOBAL",
  brandAccent: ".",
  url: "https://shopifybureau.nl",
  name: "Sarte Global",
...
export const TRUST_LINE =
  "Shopify Bureau Nederland — een dienst van Sarte Global." as const;

/**
 * The 12 service pages — single source for the "Services" nav dropdown, the
...
export const SERVICE_LINKS: readonly NavLink[] = [
  ...
  { label: "WooCommerce bureau", href: "/woocommerce-bureau" },
  { label: "Shopify bureau", href: "/shopify-bureau" },
  { label: "B2B website", href: "/b2b-website" },
  { label: "B2C website", href: "/b2c-website" },
...
export const NAV_ITEMS: readonly NavItem[] = [
  { kind: "link", label: "Shopify Bureau", href: "/", shortLabel: "Shopify Bureau" },
  ...
  { kind: "link", label: "WooCommerce bureau", href: "/woocommerce-bureau", shortLabel: "WooCommerce bureau" },
  { kind: "link", label: "Shopify bureau", href: "/shopify-bureau", shortLabel: "Shopify bureau" },
...
export const HERO = {
  ...
  title: [
    {
      words: [
        { text: "Shopify Webshop Laten Maken", italicAccent: true },
      ],
    },
  ],
  subtitle:
    "Uw Shopify bureau in Nederland. Wij bouwen professionele Shopify- en WooCommerce-webshops voor ondernemers en bedrijven — met sterke SEO, snelle oplevering en focus op conversie.",
  ...
  scrollLabel: "Scroll",
  badgeText:
    "SHOPIFY BUREAU NEDERLAND · SARTE GLOBAL · SHOPIFY WEBSHOP LATEN MAKEN · SARTE GLOBAL · ",
...
export const FOOTER_MISSION =
  "Professionele Shopify webshops en e-commerce oplossingen voor ondernemers en bedrijven in Nederland. Sarte Global — uw Shopify bureau voor groei, conversie en online succes." as const;
