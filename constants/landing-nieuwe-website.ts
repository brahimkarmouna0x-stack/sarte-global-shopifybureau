...
export const LANDING_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je bedrijf en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel — helder, bureau en zonder verplichtingen.",
  urgency: "Nog 3 projectplekken beschikbaar deze maand",
  points: [
    "Reactie binnen 1 werkdag",
    "Vrijblijvend & volledig bureau",
