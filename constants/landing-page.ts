...
export const LANDINGPAGE_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je campagne en doel. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je landing page laten maken — helder en bureau.",
