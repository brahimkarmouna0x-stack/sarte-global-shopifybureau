...
export const NEXTJS_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je bedrijf en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je Next.js website laten maken — helder en bureau.",
