...
export const PRICING_SECTION = {
  ...
  sub: "Kies een dienst en zie direct wat een website, webshop of campagne kost — van een vliegende start tot volledig maatwerk. Transparante prijzen, een heldere scope en altijd een eerlijke offerte bureau.",
...
export const SERVICE_PRICING = [
  ...
  },
  {
    ...
    faq: [
      {
        ...
        answer:
          "Een webshop laten maken start bij Sarte Global vanaf €1.995. De prijs hangt af van het aantal producten, de gewenste betaalmethoden, koppelingen met je boekhouding en de mate van maatwerk. Na een korte intake ontvang je een offerte bureau met een heldere scope — zonder verborgen kosten.",
      },
      {
    ...
    seo: {
      ...
      body: "De kosten van een webshop laten maken verschillen sterk per project. Bij Sarte Global start een professionele webshop vanaf €1.995, terwijl een uitgebreid platform met honderden artikelen, B2B-prijzen en koppelingen met voorraad en boekhouding oploopt vanaf €7.500. Je krijgt daarom geen standaardprijs, maar een transparante offerte bureau die past bij jouw assortiment en groeiplannen. We bouwen webshops die niet alleen mooi zijn, maar vooral verkopen: snelle productpagina's, alle Nederlandse betaalmethoden en een checkout die is geoptimaliseerd om winkelwagenuitval te verlagen. Zo telt elke euro die je investeert mee aan meer omzet. Vraag een vrijblijvende offerte aan en ontdek wat een professionele webshop voor jouw onderneming kan opleveren.",
    },
  },
  {
    slug: "ui-ux-design",
    ...
    faq: [
      {
        ...
        answer:
          "UX/UI design start bij Sarte Global vanaf €499 voor één landingspagina-ontwerp. De prijs hangt af van het aantal schermen, de hoeveelheid onderzoek en of je een volledig design system nodig hebt. Na een korte intake ontvang je een offerte bureau met een heldere scope.",
      },
      {
  ...
  },
  {
    ...
    comparison: [
      { label: "Aantal video's", values: ["4", "8–10", "bureau"] },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Video editing start bij Sarte Global vanaf €199 voor een serie social video's. De kosten hangen af van het aantal video's, de lengte en de hoeveelheid animatie en motion graphics. Daarom werken we met heldere pakketten en, voor grotere producties, een offerte bureau — zonder verrassingen achteraf.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Een merkidentiteit start bij Sarte Global vanaf €799 voor een visuele basis met logo en huisstijl. Een volledige merkstrategie met positionering, naamgeving en een levend brandbook ligt hoger. Je ontvangt vooraf een offerte bureau, afgestemd op jouw ambitie.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Houd twee zaken uit elkaar: je advertentiebudget (dat gaat naar Google of Meta) en de kosten voor beheer en creatie. Ons beheer start vanaf €299 per maand en werkt met een offerte bureau, afgestemd op je kanalen, budget en doelen — zonder verborgen kosten.",
      },
      {
  ...
  },
  {
    ...
    comparison: [
      ...
      { label: "Conversie-copy bureau", values: ["Basis", true, true] },
    ...
    faq: [
      {
        ...
        answer:
          "De kosten van een landingspagina hangen af van de hoeveelheid maatwerk in copy, design en tracking, en of je A/B-tests en koppelingen wilt. Je ontvangt vooraf een offerte bureau met een duidelijke scope.",
      },
      {
        question:
    ...
    faq: [
      {
        ...
        answer:
          "De prijs van een app laten maken hangt af van de functionaliteit, het aantal schermen, de benodigde backend en of je native modules nodig hebt. Na een korte strategiesessie ontvang je een offerte bureau met een duidelijke scope.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "De kosten hangen af van de complexiteit van de use-case, de kwaliteit van je data en of je een prototype of een productieklare oplossing wilt. We starten graag klein met een prototype en schalen op wat bewezen waarde levert — altijd met een offerte bureau.",
      },
      {
