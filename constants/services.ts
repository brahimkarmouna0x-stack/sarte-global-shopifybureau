...
export const SERVICES = [
  {
    ...
    cta: {
      ...
      titleEm: "website?",
      sub: "Vertel ons kort over jouw bedrijf. Binnen 24 uur ontvang je een vrijblijvende offerte bureau.",
  ...
  },
  {
    ...
    icon: "cart",
    heroEyebrow: "Dienst · E-commerce oplossingen",
    ...
    process: [
      ...
      },
      {
        ...
        title: "Ontwerp",
        description:
          "Een storefront die past bij jouw merk — productpagina's, collecties en checkout bureau.",
      },
      {
        number: "03",
        title: "Bouw",
    ...
    cta: {
      ...
      primaryLabel: "Offerte aanvragen",
      primaryHref:
        "mailto:info@sarteglobal.com?subject=Webshop%20laten%20maken",
      secondaryLabel: "Plan kennismaking",
      secondaryHref: "#cta",
    },
  },
...
export const SERVICE_FAQ = [
  ...
  },
  {
    ...
    answer:
      "De kosten zijn afhankelijk van jouw wensen. Onze pakketten starten bij een voordelig instapmoment. Neem vrijblijvend contact op voor een offerte bureau — we denken graag met je mee.",
  },
  {
