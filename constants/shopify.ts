...
export const SHOPIFY_META = {
  path: "/shopify-bureau",
  // Title: 54 chars — primary keyword first, brand last
  title: "Shopify webshop laten maken | Shopify bureau | Sarte Global",
  // Description: 148 chars — natural Dutch, USP + CTA
  description:
    "Shopify webshop laten maken bij Shopify specialist Sarte Global. Professionele Shopify-webshops met mobiele checkout, iDEAL & sterke SEO. Vraag een offerte aan!",
  keywords: [
    ...
    "shopify agency nederland",
    "shopify developer inhuren",
    "shopify thema op maat",
    "shopify seo",
    "shopify seo specialist",
    "shopify conversie optimalisatie",
    "shopify ideal integratie",
    "b2b shopify webshop",
    "shopify migratie nederland",
    "shopify plus bureau",
  ...
  ogAlt: "Shopify webshop laten maken · Sarte Global — Shopify bureau Nederland",
} as const;

export const SHOPIFY_HERO = {
  eyebrow: "Shopify bureau · Sarte Global",
...
export const SHOPIFY_COMPARISON = {
  ...
  rows: [
    {
      label: "Design bureau van jouw merk",
      us: "Volledig uniek",
...
export const SHOPIFY_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Shopify heeft een overzichtelijk dashboard waarmee je producten, prijzen, voorraad en bestellingen eenvoudig beheert. We geven een korte uitleg na oplevering, en je kunt het beheer ook aan ons uitbesteden.",
  },
  {
...
export const SHOPIFY_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je producten en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je Shopify webshop laten maken — helder en zonder verrassingen.",
