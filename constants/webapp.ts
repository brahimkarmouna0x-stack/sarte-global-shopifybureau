...
export const WEBAPP_META = {
  ...
  description:
    "Webapp laten maken bureau: SaaS, dashboards, klantportalen en interne tools, gebouwd op een moderne, schaalbare stack (Next.js & React). Veilig, snel en klaar voor groei. Vraag vrijblijvend een voorstel aan.",
  keywords: [
    "webapp laten maken",
...
export const WEBAPP_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je idee en proces. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je webapp laten maken — helder, gefaseerd en bureau.",
