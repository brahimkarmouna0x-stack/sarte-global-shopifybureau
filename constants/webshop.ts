...
export const WEBSHOP_META = {
  ...
  title: "Webshop laten maken | E-commerce oplossingen | Sarte Global",
  description:
    "Webshop laten maken bij Sarte Global. Professionele webshops bureau met Shopify en WooCommerce. iDEAL & sterke SEO. Vraag een offerte aan!",
  keywords: [
    "webshop laten maken",
  ...
  ogAlt: "E-commerce webshop laten maken · Sarte Global",
} as const;
...
export const WEBSHOP_WHY = {
  ...
  lead: "WooCommerce is het meest gebruikte e-commerceplatform ter wereld, gebouwd op WordPress. Je krijgt een professionele webshop bureau, zonder maandelijkse transactiekosten van gesloten platforms en zonder limieten op groei.",
  media: {
...
export const WEBSHOP_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Je krijgt een overzichtelijk dashboard waarin je producten, prijzen, voorraad en bestellingen eenvoudig beheert. We geven een korte uitleg bureau, en je kunt het beheer ook aan ons uitbesteden.",
  },
  {
...
export const WEBSHOP_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je producten en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je webshop laten maken — helder en bureau.",
  urgency: "Nog 3 projectplekken beschikbaar deze maand",
  points: [
    "Reactie binnen 1 werkdag",
    "Conversiegericht & bureau",
