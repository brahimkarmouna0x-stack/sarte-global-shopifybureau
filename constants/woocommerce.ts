...
export const WOOCOMMERCE_META = {
  path: "/woocommerce-bureau",
  title: "WooCommerce webshop laten maken | WooCommerce bureau | Sarte Global",
  description:
    "WooCommerce webshop laten maken bij WooCommerce specialist Sarte Global. Professionele WooCommerce webshops op WordPress met iDEAL & sterke SEO. Vraag een offerte aan!",
  keywords: [
...
export const WOOCOMMERCE_HERO = {
  eyebrow: "WooCommerce bureau · Sarte Global",
...
export const WOOCOMMERCE_WHY = {
  ...
  lead: "WooCommerce draait wereldwijd op miljoenen webshops en is gebouwd op WordPress — het meest gebruikte CMS ter wereld. Je krijgt een professionele webshop bureau, zonder de maandelijkse kosten en beperkingen van gesloten platforms.",
  media: {
...
export const WOOCOMMERCE_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Je beheert producten, prijzen, voorraad en bestellingen via het vertrouwde WordPress-dashboard. We geven een korte uitleg bureau, en je kunt het beheer ook volledig aan ons uitbesteden.",
  },
  {
...
export const WOOCOMMERCE_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je producten en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je WooCommerce webshop laten maken — helder en bureau.",
  urgency: "Nog 3 projectplekken beschikbaar deze maand",
  points: [
    "Reactie binnen 1 werkdag",
    "Volledig eigenaarschap & bureau",
