...
export const WORDPRESS_HERO = {
  ...
  sub: "Sarte Global bouwt professionele WordPress-websites bureau — modern, snel en SEO-sterk. Je past teksten en beelden zelf moeiteloos aan via een overzichtelijk CMS, zonder technische kennis.",
...
export const WORDPRESS_WHY = {
  ...
  paragraphs: [
    "Een WordPress website laten maken betekent dat je kiest voor het meest flexibele en best ondersteunde CMS ter wereld. Je krijgt een professionele website met een ontwerp bureau, maar houdt zelf de regie: content aanpassen doe je voortaan in een paar klikken.",
...
export const WORDPRESS_COMPARISON = {
  ...
  rows: [
    ...
    {
      label: "Professioneel design bureau",
      us: "Rond jouw merk",
...
export const WORDPRESS_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Dat is juist de kracht van WordPress. Je krijgt een overzichtelijk dashboard waarmee je teksten, beelden en pagina's zelf aanpast. We leveren een korte uitleg bureau op, en je kunt het beheer ook volledig aan ons uitbesteden.",
  },
  {
...
export const WORDPRESS_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je bedrijf en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je WordPress website laten maken — helder en bureau.",
