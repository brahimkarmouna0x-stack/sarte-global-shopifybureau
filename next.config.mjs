...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/services/ecommerce", destination: "/ecommerce-oplossingen", permanent: true },
      ...
      // Slugs migration redirects for shopifybureau.nl
      { source: "/webshop-laten-maken", destination: "/ecommerce-oplossingen", permanent: true },
      { source: "/shopify-webshop-laten-maken", destination: "/shopify-bureau", permanent: true },
      { source: "/woocommerce-webshop-laten-maken", destination: "/woocommerce-bureau", permanent: true },
